...
现在的 Kali Linux 就像你刚安装它时一样干净、沉默。

学员，从今天起，你正式入门了。

- 你懂得 **敬畏**（因为你见过勒索软件的破坏力）。
- 你懂得 **伪装**（因为你穿过 Tor 的隐身衣）。
- 你懂得 **控制**（因为你拿到了服务器的 Shell）。





**别干等着！这是 Linux 新手最常遇到的“假死”现场。**

### 🚨 紧急脱困 (Emergency Exit)

不管你现在的终端显示什么，或者光标是不是在傻傻地闪，请立刻执行这个**万能终止快捷键**：

**狂按 `Ctrl + C`**

*(按两三下，直到你再次看到熟悉的 `$` 或者 `kali@kali` 提示符出现。)*
